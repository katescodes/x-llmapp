    ...
    <div style={{ padding: "20px", color: "#e5e7eb", height: "100%", overflow: "auto" }}>
      ...
      <div style={{
        ...
        {canAccessDocComponents && (
          <button
            onClick={() => setCurrentTab('docComponents')}
            style={{
              padding: "10px 20px",
              background: currentTab === 'docComponents' ? "rgba(79, 70, 229, 0.2)" : "transparent",
              color: currentTab === 'docComponents' ? "#22c55e" : "#94a3b8",
              border: "none",
              borderBottom: currentTab === 'docComponents' ? "2px solid #22c55e" : "none",
              borderRadius: "6px 6px 0 0",
              cursor: "pointer",
              fontSize: "14px",
              fontWeight: currentTab === 'docComponents' ? "600" : "normal",
              transition: "all 0.2s"
            }}
          >
            📝 文档组件
      ...
      {/* 文档组件管理标签页 */}
      {currentTab === 'docComponents' && (
        <div style={{ 
          height: "calc(100vh - 200px)", 
          overflow: "hidden",
          margin: "-20px" // 移除padding以让组件全屏显示
        }}>
