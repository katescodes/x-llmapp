...
from app.services.tender.doc_blocks import extract_blocks
from app.services.tender.snippet_locator import locate_format_chapter
from app.services.tender.snippet_llm import (
    detect_snippets,
